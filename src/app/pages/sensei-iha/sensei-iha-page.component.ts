...
@Component({
  ...
  template: `
    <iha-section [title]="'Seikichi Iha<br/><small>Hanshi, 10th Dan</small>'" [subTitle]="'<small>1932-2024</small>'">
      <p>Seikichi Iha was born in the town of Nishihara, Okinawa Prefecture, Japan on July 9, 1932.</p>

      <p>Iha Sensei described his childhood hometown as a close-knit community of families and friends with strong feelings of caring for each other and tradition. He said there were no karate dojos in those days. Although at that time karate was taught individually and in private, many old people talked about it and everyone had heard stories.</p>

      <p>Life on the peaceful island of Okinawa changed abruptly after military invasion and the final WWII Battle of Okinawa (April-June 1945) which left massive losses of civilian and military lives and widespread destruction of towns and villages. It had a major effect on surviving Okinawans including Iha Sensei. The town of <a href="https://en.wikipedia.org/wiki/Nishihara,_Okinawa" target="_blank">Nishihara</a> was entirely destroyed and 47% of its population killed. (Iha Sensei took his students to the Peace Memorial Park and Peace Memorial Museum on visits to Okinawa so they might understand the devastating effects of war and importance of seeking peace.)</p>

      <p>Iha Sensei began his karate training in 1948 under his family friend ("like an uncle"). In 1950 he was introduced and accepted as a formal student of <a routerLink="/history/gusukuma-shinpan">Shinpan Gusukuma</a>. Gusukuma was a student of the famous <a routerLink="/history/itosu-anko">Anko Itosu</a> and was a well respected authority of Shuri-te. Gusukuma was an educator and also noted for his healing skills (similar to an acupuncturist). He was very particular as to who he would take as a student. He was also very strict and scientific in his training and application of karate do.</p>

      <p>Although Gusukuma was physically small in size, he was very powerful in his techniques, believing that a karate-man worth his salt could hit with force equal to three times his own body weight. Gusukuma was a stickler on conditioning the body through body contact and through the practice of the makiwara punching board. This concept has been passed on to all of Iha Sensei's students.</p>

      <p>Iha trained with Gusukuma for four years. After Gusukuma's death in 1954, Iha was introduced to his next teacher by his good friend, Shoei Miyazato. Iha met <a routerLink="/history/miyahira-katsuya">Katsuya Miyahira</a> in 1954 and was accepted as a student shortly thereafter. Miyahira was very much like Gusukuma in that he was a school teacher with a very strict and scientific method of teaching karate do.</p>

      <p>Iha progressed in karate do at a steady pace so that by 1963 he had been promoted to the rank of 5th Dan Shihan in Okinawa Shorin Ryu. At that time, Katsuya Miyahira received a request from the Philippine Islands asking for a Shorin Ryu instructor. Iha was chosen and spent approximately 11 months teaching Shorin Ryu at the dojo of Latino Gonzales in Manila.</p>

      <p>Iha returned to Okinawa during the latter part of 1964 and began teaching the U.S. Marines stationed at Futenma, Okinawa. At that time he was promoted to 6th Dan and opened up his own dojo in his hometown of Nishihara.</p>

      <p>In 1967 Iha Sensei was promoted to the rank of Kyoshi 7th Dan and sent to teach in Los Angeles, CA where he initially began his karate teaching at the American-Okinawan Club located in Los Angeles. Iha Sensei was the first Okinawan Master Instructor of Shorin Ryu to teach in Southern California since 1927 when Yabu Kentsu taught for the same club.</p>

      <p>After teaching Shorin Ryu at the American-Okinawan Club for five months, Iha Sensei and two other 7th Dans opened up the Shureikan Dojo on Olympic Blvd. A year later, he went off on his own and opened his Shidokan Karate Dojo on West Pico Blvd.</p>

      <p>Iha Sensei moved to the Lansing area in April of 1975. He founded his <a routerLink="/our-dojo-story">Original Okinawa Karate dojo</a> where he taught until 2024. In September of 1978 he was promoted to Kyoshi 8th Dan. On March 12, 1989 he received his Hanshi 9th Dan certification, and on March 25, 2001, Iha Sensei was promoted to Hanshi 10th Dan by Miyahira Katsuya, making him the highest ranking Okinawan residing in the United States. His rank was certified by the Okinawa Shorin Ryu Karate Do Association. Iha Sensei also established the <a href="https://www.beikokushidokan.com/" target="_blank">Beikoku Shidokan Karatedo Association</a>.</p>

      <p>On May 19, 2020, the Okinawa Prefecture Government designated Iha Sensei as an Intangible Cultural Asset Holder in the category of Okinawa Karate and Kobujutsu, which at that time was a designation granted to only 20 karateka.</p>

      <p>Iha Sensei continued to actively teach his students until he died peacefully at his home on August 3, 2024 at age 92 surrounded by his family, students, and friends.</p>

      <p>To learn more about Iha Sensei, his Lansing MI dojo, the Beikoku Shidokan Karatedo Association he founded and the history and lineage of the Shorin Ryu Shidokan Okinawan karate he taught, visit:</p>

      <ul>
        <li><a routerLink="/our-dojo-story">Our Dojo Story</a></li>
        <li><a href="https://www.facebook.com/OriginalOkinawaKarateIhaDojo" target="_blank">Iha Dojo on Facebook</a></li>
        <li><a href="https://www.beikokushidokan.com/" target="_blank">Beikoku Shidokan Karatedo Association </a></li>
      </ul>
    </iha-section>
